...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CL3n8YyU.mjs");
...
var manifest = {
	"4a7d5cc10d03dc35c24d461f6580453b2d82785295ed2e73f32af789f2916a1e": {
		functionName: "createAppUser_createServerFn_handler",
		importer: () => import("./users.functions-CVv2aLRk.mjs")
	},
	"77865b4e305c95f1423001afc08de2e249b67667660b2fb28ecb0cee3b07c9f1": {
		functionName: "updateAppUser_createServerFn_handler",
		importer: () => import("./users.functions-CVv2aLRk.mjs")
	},
	"84331f4465f1b54530cd1bf975dc7ba02ac96e2f8d6442586747aafad0638898": {
		functionName: "listAppUsers_createServerFn_handler",
		importer: () => import("./users.functions-CVv2aLRk.mjs")
	},
	"ec9cac7b56b1cb49c4fdb830ab7b2be6ed329f3374dada64d760e951daab2adc": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C9FPYSkn.mjs").then((n) => n.t),
		import("./start-UnKc4yw9.mjs"),
...
//#endregion
export { getServerFnById as a, __exportAll as c, TSS_SERVER_FUNCTION as i, createCsrfMiddleware as n, getRequest as o, createServerFn as r, createMiddleware as s, server_exports as t };
